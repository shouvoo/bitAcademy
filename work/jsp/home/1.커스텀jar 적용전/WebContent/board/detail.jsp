...
<div class="container">	
	...
	<a href="${pageContext.request.contextPath}/board/modifyform?no=${board.no}">수정</a>
	...
	<table border=1>
		<tbody>
				...
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/board/commentmodifyform?no=${comment.no}&commentNo=${comment.commentNo}">수정</a></td>
					<td><a href="${pageContext.request.contextPath}/board/commentdelete?no=${comment.no}&commentNo=${comment.commentNo}">삭제</a></td> 
				</tr>
				</c:forEach>
				<tr>
