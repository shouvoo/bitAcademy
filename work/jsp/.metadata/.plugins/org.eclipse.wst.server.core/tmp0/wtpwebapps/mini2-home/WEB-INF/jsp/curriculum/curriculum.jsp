...
<link rel="stylesheet" type="text/css" href="/mini2-home/css/curriculum.css" />
<script type="text/javascript">
	var user = "${user.id}";
	var memberNo = "${user.memberNo}";
</script>

<script src="/mini2-home/js/curriculum.js"></script>
</head>
<body>
	...
	<div class="backLayer">
		...
		<div id="writePopup">
			<form id="frm">
				...
				<input type="hidden" name="writer" value='${user.id}'><br>
				<input type="hidden" name="memberNo" value='${user.memberNo}'><br>
